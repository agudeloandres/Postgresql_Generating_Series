-- http://sqlfiddle.com/#!17/ec332/2
-- Generating around 100 contacts, with data taken on previously created companies
-- all datas are just generated in this select, not yet inserted
